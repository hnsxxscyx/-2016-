...
## 功能要求与实现方案
- 背景图需要进行模糊处理
    - 因为子元素不需要模糊，本拟放弃filter: blur(),使用backdrop-filter: blur()属性，参照这篇文章[高级CSS filters ](https://www.w3cplus.com/css3/advanced-css-filters.html)
    - 后因《CSS揭秘》对文字背景进行模糊启发，给伪元素设置一层新背景图，对此张进行模糊，达到模糊目的
    - 经搜索发现另一种模糊方案[CSS3实现文字流光渐变动画](http://yanyuanfe.cn/2017/03/18/CSS3%E5%AE%9E%E7%8E%B0%E6%96%87%E5%AD%97%E6%B5%81%E5%85%89%E6%B8%90%E5%8F%98%E5%8A%A8%E7%94%BB/),但此方案加了一层无用容器
- 按钮边框的从中间到两边扩展开
    - 动画不能对边框进行单独设置，放弃
